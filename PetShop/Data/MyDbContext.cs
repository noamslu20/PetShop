    ...
    public class MyDbContext:DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Comment>().HasData(
                new { CommentId = 1, AnimalId = 1, CommentMessage = "good animal" },
                new { CommentId = 2, AnimalId = 1, CommentMessage = "decent animal" },
                new { CommentId = 3, AnimalId = 1, CommentMessage = "not bad animal" },
                new { CommentId = 4, AnimalId = 2, CommentMessage = "nice animal" },
                new { CommentId = 5, AnimalId = 2, CommentMessage = "good lizard" },
                new { CommentId = 6, AnimalId = 3, CommentMessage = "pinguins are okay animal" }
                );
